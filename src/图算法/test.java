...
//        Code01_BFS.bfs(a);
    ...
    // 尽快的将课程安排到前几个学期内==================
    // 第1学期课程安排： 课程: C09 学分：7 课程: C01 学分：2
    // 第2学期课程安排： 课程: C10 学分：5 课程: C02 学分：3 课程: C11 学分：2
    // 第3学期课程安排： 课程: C03 学分：4 课程: C12 学分：3 课程: C04 学分：3
    // 第4学期课程安排： 课程: C06 学分：3 课程: C05 学分：2
    // 第5学期课程安排： 课程: C08 学分：4 课程: C07 学分：4
    // 第6学期课程安排：

    //各学期的课程尽量均匀==================
    //第1学期课程安排： 课程: C09 学分：7 课程: C01 学分：2
    //第2学期课程安排： 课程: C10 学分：5 课程: C02 学分：3
    //第3学期课程安排： 课程: C03 学分：4 课程: C12 学分：3
    //第4学期课程安排： 课程: C04 学分：3 课程: C11 学分：2
